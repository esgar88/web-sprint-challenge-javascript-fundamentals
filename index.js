...
function animalNames(animalName, scientificName) {
	const displayNames = [];

	zooAnimals.forEach(function (zooAnimals) {
		return displayNames.push(`name: ${animalName}, ${scientificName}`);
	});
}
...
function lowerCaseNames(name) {
	...
	zooAnimals.map(function (zooAnimals) {
		return lowerCase.push(zooAnimals.lowerCase);
	});
}
...
function lowPopulationAnimals() {
	...
	zooAnimals.filter(function (zooAnimals) {
		return lowPopulationAnimals.push(zooAnimals);
	});
}
